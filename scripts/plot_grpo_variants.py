...
RUNS = {
    "Standard GRPO": Path("experiments/grpo_standard/metrics_seed42.jsonl"),
    "GRPO constant": Path("experiments/grpo_grpo_constant/metrics_seed42.jsonl"),
    "Dr. GRPO": Path("experiments/grpo_dr_grpo/metrics_seed42.jsonl"),
    "RFT": Path("experiments/grpo_rft/metrics_seed42.jsonl"),
    "MaxRL": Path("experiments/grpo_maxrl/metrics_seed42.jsonl"),
}
...
def main() -> None:
    output_path = Path(
        sys.argv[1] if len(sys.argv) > 1 else "experiments/grpo_variants_seed42.png"
    )
