...
import json
from post_training.gsm8k_grader import r1_zero_reward_fn, question_only_reward_fn
...
prompt_configs = {
    "question_only": {
        "prompt_path": "post_training/prompts/gsm8k/question_only.prompt",
    ...
    "r1_zero_three_shot_gsm8k": {
        "prompt_path": "post_training/prompts/gsm8k/r1_zero_three_shot_gsm8k.prompt",
        "reward_fn": r1_zero_reward_fn,
        "stop": ["</answer>"],
    },
}
