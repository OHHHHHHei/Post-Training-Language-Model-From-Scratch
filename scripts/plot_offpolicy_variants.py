...
RUNS = {
    "Naive": Path("experiments/grpo_offpolicy_naive/metrics_seed42.jsonl"),
    "No clip": Path("experiments/grpo_offpolicy_noclip/metrics_seed42.jsonl"),
    "Token clip": Path("experiments/grpo_offpolicy_clip/metrics_seed42.jsonl"),
    "GSPO": Path("experiments/grpo_offpolicy_gspo/metrics_seed42.jsonl"),
}
...
def main() -> None:
    curve_path = Path(
        "experiments/grpo_offpolicy_variants_seed42.png"
    )
    final_path = Path(
        "experiments/grpo_offpolicy_final_seed42.png"
    )
